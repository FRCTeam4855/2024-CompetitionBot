...
public class RobotContainer {
        ...
        XboxController m_operatorController1 = new XboxController(kOperatorControllerPort);
        XboxController m_operatorController2 = new XboxController(kOperatorControllerPort);
